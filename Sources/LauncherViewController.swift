...
//    lazy var viewer3DDocument = Viewer3DDocument(config: config, token: token)
//    lazy var viewerMosaicDocument = ViewerMosaicDocument(config: config, token: token)
//    lazy var viewerBasicPDFDocument = ViewerBasicPDFDocument(config: config, token: token)
//    lazy var viewerPDFDocument = ViewerPDFDocument(config: config, token: token)
...
//        viewerBasicPDFDocument.shuffleFileId()
        let viewer = ViewerBasicPDFViewController()
